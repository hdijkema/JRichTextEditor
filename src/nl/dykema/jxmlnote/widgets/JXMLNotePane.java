...
import nl.dykema.jxmlnote.clipboard.XMLNoteTransferHandler;
...
import nl.dykema.jxmlnote.undo.JXMLNotePaneCaretUndoableEdit;
...
public class JXMLNotePane extends JTextPane implements DocumentAdminListener, DocumentListener {
	 ...
	 * see {@link nl.dykema.jxmlnote.document.XMLNoteDocument#getMarksForOffset(int) XMLNoteDocument.getMarksForOffset}. 
	 * @return
	 */
	 ...
	 * see {@link nl.dykema.jxmlnote.document.XMLNoteDocument#getMarksForSelection(int,int) XMLNoteDocument.getMarksForSelection}.
	 ...
	 * 
	 * see {@link nl.dykema.jxmlnote.document.XMLNoteDocment.getMarksContainedInSelection(int,in) XMLNoteDocument.getMarksContainedInSelection).
	 * 
	 * @throws NoSelectionException
	 * @return
	 */
