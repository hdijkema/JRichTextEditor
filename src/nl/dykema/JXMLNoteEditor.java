...
import nl.dykema.jxmlnote.toolbar.JXMLNoteToolBarReflect;
import nl.dykema.jxmlnote.undo.XMLNoteUndoManager;
import nl.dykema.jxmlnote.utils.JXMLNoteConstants;
import nl.dykema.jxmlnote.widgets.JXMLNotePane;
import nl.dykema.jxmlnote.widgets.JXMLNoteRuler;
...
public class JXMLNoteEditor extends JScrollPane implements ActionListener {
	...
	/**
	 * Proxy for {@link nl.dykema.jxmlnote.widgets.JXMLNotePane#getMarksForSelection  pane().getMarksForSelection()}
	 * 
	...
	/**
	 * Proxy for {@link nl.dykema.jxmlnote.widgets.JXMLNotePane#getMarksForCaret()  pane().getMarksForCaret()}.
	 * 
	 * @return
	 */
	...
	/**
	 * Proxy for {@link nl.dykema.jxmlnote.widgets.JXMLNotePane#getMarksContainedInSelection() pane().getMarksContainedInSelection()}.
	 * @return
	 * @throws NoSelectionException
	 */
	...
	/**
	 * Proxy for {@link nl.dykema.jxmlnote.widgets.JXMLNotePane#insertMark(String) pane().insertMark()}.
	...
	/**
	 * Proxy for {@link nl.dykema.jxmlnote.widgets.JXMLNotePane#removeMark(String) pane().removeMark()}.
	 * @param id
	 * @return
	...
	/**
	 * Sets the {@link nl.dykema.jxmlnote.widgets.JXMLNotePane#setComponentPopupMenu(JPopupMenu) popup menu for  XMLNotePane} .
	 */
	...
	/**
	 * Proxy for {@link nl.dykema.jxmlnote.widgets.JXMLNotePane#selectionSize() JXMLNotePane.selectionSize()}.
	 * @return
	 */
