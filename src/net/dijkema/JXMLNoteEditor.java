...
import net.dijkema.jxmlnote.events.JXMLNoteEditorActionListener;
...
import net.dijkema.jxmlnote.toolbar.JXMLNoteToolBarReflect;
import net.dijkema.jxmlnote.undo.XMLNoteUndoManager;
import net.dijkema.jxmlnote.utils.JXMLNoteConstants;
...
public class JXMLNoteEditor extends JScrollPane implements ActionListener {
	...
	/**
	 * Proxy for {@link net.dijkema.jxmlnote.widgets.JXMLNotePane#getMarksForSelection  pane().getMarksForSelection()}
	 * 
	...
	/**
	 * Proxy for {@link net.dijkema.jxmlnote.widgets.JXMLNotePane#getMarksForCaret()  pane().getMarksForCaret()}.
	 * 
	 * @return
	 */
	...
	/**
	 * Proxy for {@link net.dijkema.jxmlnote.widgets.JXMLNotePane#getMarksContainedInSelection() pane().getMarksContainedInSelection()}.
	 * @return
	 * @throws NoSelectionException
	 */
	...
	/**
	 * Proxy for {@link net.dijkema.jxmlnote.widgets.JXMLNotePane#insertMark(String) pane().insertMark()}.
	...
	/**
	 * Proxy for {@link net.dijkema.jxmlnote.widgets.JXMLNotePane#removeMark(String) pane().removeMark()}.
	 * @param id
	 * @return
	...
	/**
	 * Sets the {@link net.dijkema.jxmlnote.widgets.JXMLNotePane#setComponentPopupMenu(JPopupMenu) popup menu for  XMLNotePane} .
	 */
	...
	/**
	 * Proxy for {@link net.dijkema.jxmlnote.widgets.JXMLNotePane#selectionSize() JXMLNotePane.selectionSize()}.
	 * @return
	 */
