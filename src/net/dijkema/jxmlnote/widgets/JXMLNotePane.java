...
import net.dijkema.jxmlnote.clipboard.XMLNoteTransferHandler;
...
import net.dijkema.jxmlnote.interfaces.UpdateViewListener;
import net.dijkema.jxmlnote.toolbar.JXMLNoteToolBar;
import net.dijkema.jxmlnote.undo.JXMLNotePaneCaretUndoableEdit;
...
public class JXMLNotePane extends JTextPane implements DocumentAdminListener, DocumentListener {
	 ...
	 * see {@link net.dijkema.jxmlnote.document.XMLNoteDocument#getMarksForOffset(int) XMLNoteDocument.getMarksForOffset}. 
	 * @return
	 */
	 ...
	 * see {@link net.dijkema.jxmlnote.document.XMLNoteDocument#getMarksForSelection(int,int) XMLNoteDocument.getMarksForSelection}.
	 ...
	 * 
	 * see {@link net.dijkema.jxmlnote.document.XMLNoteDocment.getMarksContainedInSelection(int,in) XMLNoteDocument.getMarksContainedInSelection).
	 * 
	 * @throws NoSelectionException
	 * @return
	 */
