...
package net.dijkema.jxmlnote.toolbar;
...
import net.dijkema.jxmlnote.icons.Close;
import net.dijkema.jxmlnote.icons.Document_new;
import net.dijkema.jxmlnote.icons.Document_open;
import net.dijkema.jxmlnote.icons.Document_save;
import net.dijkema.jxmlnote.icons.Edit_copy;
import net.dijkema.jxmlnote.icons.Edit_cut;
import net.dijkema.jxmlnote.icons.Edit_paste;
import net.dijkema.jxmlnote.icons.Edit_redo;
import net.dijkema.jxmlnote.icons.Edit_select_all;
import net.dijkema.jxmlnote.icons.Edit_undo;
import net.dijkema.jxmlnote.icons.First;
import net.dijkema.jxmlnote.icons.FlamencoIconAdapter;
import net.dijkema.jxmlnote.icons.Format_indent_less;
import net.dijkema.jxmlnote.icons.Format_indent_more;
import net.dijkema.jxmlnote.icons.Help;
import net.dijkema.jxmlnote.icons.InsertHyperlink;
import net.dijkema.jxmlnote.icons.Last;
import net.dijkema.jxmlnote.icons.Next;
import net.dijkema.jxmlnote.icons.NoImage;
import net.dijkema.jxmlnote.icons.Previous;
import net.dijkema.jxmlnote.icons.Print;
import net.dijkema.jxmlnote.icons.PrintPrefs;
import net.dijkema.jxmlnote.icons.Quit;
import net.dijkema.jxmlnote.icons.RemoveHyperlink;
import net.dijkema.jxmlnote.icons.Zoom100;
import net.dijkema.jxmlnote.icons.ZoomFitHeight;
import net.dijkema.jxmlnote.icons.ZoomFitWidth;
import net.dijkema.jxmlnote.icons.ZoomLess;
import net.dijkema.jxmlnote.icons.ZoomMore;
